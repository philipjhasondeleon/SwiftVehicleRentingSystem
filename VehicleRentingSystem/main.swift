...
var d5 = Driver(id: 5, firstName: "Robb", lastName: "Seton", gender: .Male, birthDate: Date.from(year: 1996, month: 3, day: 5), mobileNumber: 1109340421, emailId: "rseton4@alibaba.com", userName: "rseton4", passWord: "W4j2wkmAjex", drivingLicenseNo: "X1059-2321-6215", isDrivingHistoryCleared: true, salary: 52392)
...
//adding vehicles to owner class

o1.addVehicleListOwned(vehicles: m1)
o2.addVehicleListOwned(vehicles: car2)
o3.addVehicleListOwned(vehicles: b5)
o4.addVehicleListOwned(vehicles: m4)
